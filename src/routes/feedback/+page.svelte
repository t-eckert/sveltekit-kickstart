...
<div class="mx-auto max-w-4xl px-4 py-12">
	<div class="text-center mb-8">
		<div class="flex items-center justify-center mb-4">
			<ChatCircle size={32} class="text-blue-600 dark:text-blue-400 mr-2" />
			<H1 text="Feedback" />
		</div>
				...
				{#snippet children()}
					{#if form?.success}
						...
						<div class="text-center py-8">
							<CheckCircle size={48} class="text-green-600 dark:text-green-400 mx-auto mb-4" />
							<H2 text="Thank You!" />
							...
							<div class="space-y-6">
								...
								<div>
									...
									<input
										...
										class="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
									/>
									<p class="mt-1 text-xs text-gray-500">We'll only use this to follow up if needed</p>
								</div>
				...
				{#snippet children()}
					...
					<div class="mt-4 space-y-3 text-sm text-gray-600 dark:text-gray-300">
						<div class="flex items-start space-x-2">
							<span class="block w-2 h-2 bg-blue-500 rounded-full mt-1.5 flex-shrink-0"></span>
