...
<DropdownMenu.Root>
	<DropdownMenu.Trigger
		class="border-input text-foreground shadow-btn hover:bg-muted inline-flex h-10 w-10 items-center justify-center rounded-full border text-sm font-medium select-none active:scale-[0.98]"
	>
		...
		>
			...
			<DropdownMenu.Sub>
				<DropdownMenu.SubTrigger
					class="rounded-button data-highlighted:bg-muted data-[state=open]:bg-muted flex h-10 items-center py-3 pr-1.5 pl-3 text-sm font-medium ring-0! ring-transparent! select-none focus-visible:outline-none"
				>
					<div class="flex items-center">
