...
<ContextMenu.Root>
	<ContextMenu.Trigger
		class="rounded-card border-border-input text-muted-foreground flex h-[188px] w-[279px] items-center justify-center border-2 border-dashed bg-transparent font-semibold select-none"
	>
	...
	<ContextMenu.Portal>
		...
		>
			<ContextMenu.Item
				class="rounded-button data-highlighted:bg-muted flex h-10 items-center py-3 pr-1.5 pl-3 text-sm font-medium select-none focus-visible:outline-none"
			>
			...
			<ContextMenu.Sub>
				<ContextMenu.SubTrigger
					class="rounded-button data-highlighted:bg-muted data-[state=open]:bg-muted flex h-10 items-center py-3 pr-1.5 pl-3 text-sm font-medium select-none focus-visible:outline-none"
				>
					<div class="flex items-center">
				...
				<ContextMenu.SubContent
					class="border-muted bg-background shadow-popover z-100 w-[209px] rounded-xl border px-1 py-1.5 ring-0! ring-transparent!"
					sideOffset={10}
				>
					<ContextMenu.Item
						class="rounded-button data-highlighted:bg-muted flex h-10 items-center py-3 pr-1.5 pl-3 text-sm font-normal select-none focus-visible:outline-none"
					>
						Header
					</ContextMenu.Item>
					<ContextMenu.Item
